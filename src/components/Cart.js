 ...
 <div>
    <table style={{width:"90%", marginTop:"5%", marginLeft:"5%",marginRight:"5%"}} >
      ...
      <tbody>
        ...
        <td data-label="Quantity"><input type="text" style={{width:"10px",padding:"5px",marginRight:"10px"}} placeholder="3" />x ${e.Price}</td>
          </tr>
        ))}
      </tbody>
    </table>
    ...
    <div className="subtotal cf">
          <ul>
            ...
            <li className="totalRow final">
              ...
              <span className="value">${props.dataPrice + props.tax + props.shipping}.00</span>
            </li>
            <li className="totalRow">
          ...
          <div className="cartwrapp">
            {hh.length === 0 ? (
              <h1 style={{ marginTop: "100px", marginBottom: "100px" }}>
               ...
               <Table style={{margin:"0"}} propData={hh} dataPrice={dataPrice} tax={tax}  shipping={shipping}/>
            )}
          </div>
        </div>
    </div>
